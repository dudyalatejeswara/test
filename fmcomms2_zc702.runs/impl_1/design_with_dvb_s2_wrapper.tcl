...
namespace eval ::optrace {
  variable script "/home/krisemi_satcom/adi/hdl/projects/fmcomms2/zc702/fmcomms2_zc702.runs/impl_1/design_with_dvb_s2_wrapper.tcl"
...
set rc [catch {
  ...
  open_checkpoint design_with_dvb_s2_wrapper_routed.dcp
...
set_property TOP design_with_dvb_s2_wrapper [current_fileset]
OPTRACE "read constraints: write_bitstream" START { }
OPTRACE "read constraints: write_bitstream" END { }
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  catch { write_mem_info -force -no_partial_mmi design_with_dvb_s2_wrapper.mmi }
OPTRACE "write_bitstream setup" END { }
OPTRACE "write_bitstream" START { }
  write_bitstream -force design_with_dvb_s2_wrapper.bit 
OPTRACE "write_bitstream" END { }
OPTRACE "write_bitstream misc" START { }
OPTRACE "read constraints: write_bitstream_post" START { }
OPTRACE "read constraints: write_bitstream_post" END { }
  catch {write_debug_probes -quiet -force design_with_dvb_s2_wrapper}
  catch {file copy -force design_with_dvb_s2_wrapper.ltx debug_nets.ltx}
