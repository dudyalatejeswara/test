...
HD_PWD='/home/krisemi_satcom/adi/hdl/projects/fmcomms2/zc702/fmcomms2_zc702.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_with_dvb_s2_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_with_dvb_s2_wrapper.tcl
